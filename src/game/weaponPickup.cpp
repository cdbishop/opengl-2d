...
WeaponPickup::WeaponPickup(SpriteManager::Ptr spriteManager, glm::vec2 position, std::shared_ptr<MainScene> scene)
...
{
  _sprite = std::make_shared<Sprite>("./data/textures/SpaceShooterRedux/png/Power-ups/powerupGreen_bolt.png");
